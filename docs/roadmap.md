...
- [x] 3D space view over the same board, with node kinds, architectural tiers, and connectors lifted between them *(no control sets a node kind, tier, or shape label yet)*
