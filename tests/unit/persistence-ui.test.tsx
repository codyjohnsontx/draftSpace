...
const controller = (): PersistenceController => ({ retrySave: vi.fn(), retryStorage: vi.fn(), startNewBoard: vi.fn(), openBoard: vi.fn().mockResolvedValue(true), downloadRecovery: vi.fn(), downloadCurrentBackup: vi.fn() });
